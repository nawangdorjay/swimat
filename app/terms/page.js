      ...
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-2xl shadow-sm">
        ...
        <div className="prose prose-blue max-w-none">
          ...
          <section className="mb-8">
            ...
            {/* BUG FIX: Replaced broken '#' anchor with valid internal route */}
          ...
          <section className="mb-8">
            ...
            {/* BUG FIX: Replaced broken '/privacy-policy-broken' path with correct route */}
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
             ...
             {/* BUG FIX: Replaced broken '/guidelines/selling' path with seller dashboard */}
            <a href="/seller-dashboard" className="text-blue-600 hover:underline">View Selling Guidelines</a>
          </section>
        </div>
      </div>
       {/* BUG 10 FIX: flex-grow keeps footer at bottom on short pages */}
       <div className="flex-grow"></div>
       <footer className="mt-12 pt-8 border-t border-gray-200 text-center text-gray-500 text-sm">
          <p>&copy; 2024 CampusMart. All rights reserved.</p>
          <div className="mt-2 space-x-4">
            {/* BUG 13 FIX: Replaced '#' links with real routes */}
